...
\image{noise.pdf}{1000 points samples from a circle + 200 points sampled from gaussian RV. We can see that the normal distance function creates lots of features while DTM removes most of them and leaves one that looks significant}{0.3}{1}{fig:noise}
